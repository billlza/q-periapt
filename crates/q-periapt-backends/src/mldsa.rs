...
/// Declares every FIPS 204 parameter-set adapter this crate ships, and the
/// registry of the algorithms they report.
///
/// Per parameter set: expanded signing keys first pass the adapter's canonical
/// packed-coefficient check and then `fips204`'s decoder; malformed
/// fixed-length encodings fail explicitly.
///
