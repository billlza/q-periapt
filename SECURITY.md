...
Q-Periapt 0.1.4 is the stable SemVer source line, succeeding the fully published
0.1.3 release. Security fixes are provided for
the latest ABI 2 publication set only while its verified receipt selects it as
current:

| Publication | Scope | Supported |
| --- | --- | --- |
| `0.1.4` source line | Rust source/crates and ABI 2 contract | Yes |
| `v0.1.4` | Apple XCFramework | When selected by a verified current receipt |
| `abi2-platforms-v0.1.4` | Android and GNU/Linux | When selected by a verified current receipt |
| `v0.1.3`, `abi2-platforms-v0.1.3` | Published 2026-08-25: immutable GitHub releases (Apple XCFramework; Android and GNU/Linux), plus the ten `0.1.3` crates on crates.io. This is the current published stable set, and its frozen verified receipts keep selecting the public publications until the 0.1.4 receipts verify; it is superseded once 0.1.4 publishes | Until superseded by the verified 0.1.4 receipts |
