#!/usr/bin/env python3
"""Frozen ABI-2 crates.io publication receipt for Q-Periapt 0.1.2.
...
CRATES_IO_PUBLICATION_KEY = "crates_io_v0_1_2"
...
CRATES_IO_PUBLICATION_BOUNDARY = (
    "ABI 2 Q-Periapt 0.1.2 crates.io publication receipt. Local package "
    ...
    "index both report version 0.1.2, the exact local .crate SHA-256, and "
...
_CRATE_FILE_RE = re.compile(r"^[a-z0-9][a-z0-9_-]*-0\.1\.2\.crate$")
...
validate_v0_1_2_publication_receipt = validate_crates_io_publication_receipt
