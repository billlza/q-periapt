#!/usr/bin/env python3
"""Assemble the initial source-bound 0.1.1 stable results-only successor.
    ...
    *,
    ...
    android_elf.verify_results_aar_projection(
        ...
        load_json_object_snapshot(
            ANDROID_AAR_MANIFEST_FILE,
            maximum=16 * 1024 * 1024,
            label="Android 0.1.1 stable AAR manifest projection",
        ).value,
    )
    _domain_call(
