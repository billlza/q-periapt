...
REAL_UPLOAD_ACKNOWLEDGEMENT = (
    "publish-q-periapt-abi2-v0.1.0-to-crates.io-is-irreversible"
)
...
def _main(arguments: Sequence[str]) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate, verify, or explicitly execute the ABI-2 0.1.0 "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "~/.q-periapt/publication-state/crates.io-v0.1.0 authority; "
