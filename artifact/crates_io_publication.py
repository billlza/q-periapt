...
CRATES_IO_PUBLICATION_RECEIPT_NAME = "crates-io-v0.1.5-publication-receipt.json"
CRATES_IO_PUBLICATION_JOURNAL_NAME = "crates-io-v0.1.5-upload-attempt.json"
CRATES_IO_PUBLICATION_LOCK_NAME = "qperiapt-crates-io-v0.1.5.lock"
...
REAL_UPLOAD_ACKNOWLEDGEMENT = (
    "publish-q-periapt-abi2-v0.1.5-to-crates.io-is-irreversible"
)
...
def _main(arguments: Sequence[str]) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate, verify, or explicitly execute the ABI-2 0.1.5 "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "~/.q-periapt/publication-state/crates.io-v0.1.5 authority; "
