...
class SourceResultsAssemblerTests(unittest.TestCase):
    ...
    def test_initial_and_installed_proof_maps_are_exactly_distinct(self) -> None:
        ...
        self.assertEqual(233, len(assembler.PROOF_TO_BYTE_INPUT_PATHS))
        self.assertEqual(43, len(assembler.INITIAL_BASELINE_MISSING_PROOF_INPUT_KEYS))
        self.assertEqual(190, len(initial["proof_to_byte_inputs"]))
        self.assertEqual(233, len(installed["proof_to_byte_inputs"]))
        self.assertEqual(
