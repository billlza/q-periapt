...
if [ "$VERSION" != "0.1.0-alpha.3" ]; then
	printf 'error: Android ABI2 device-smoke version mismatch: got %s, expected 0.1.0-alpha.3\n' "$VERSION" >&2
	exit 1
fi
...
public final class QPeriaptSmokeActivity extends Activity {
    ...
    private void runtimeMetadataMatches(List<String> passed) {
        ...
        expect("0.1.0-alpha.3".equals(QPeriaptAndroid.runtimeVersion()), "version mismatch");
