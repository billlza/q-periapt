...
EXPECTED_PROOF_TO_BYTE_STEP = (
    ...
    "          initial_gate=\"SOURCE_TRANSITION_READINESS_PASS mode=initial commit=$QPERIAPT_EXPECTED_GIT_COMMIT results_sha256=$results_sha256 proof_inputs=237 declared_delta=47\"\n"
    "          installed_gate=\"SOURCE_CI_GATE_MODE mode=installed commit=$QPERIAPT_EXPECTED_GIT_COMMIT results_sha256=$results_sha256 proof_inputs=237\"\n"
...
"""
    ...
    def test_ci_release_package_paths_use_the_current_stable_version(self) -> None:
        ...
        for expected in (
            "q-periapt-c-abi2-0.1.2-x86_64-pc-windows-msvc.zip",
            "q-periapt-c-abi2-0.1.2-$EXPECTED_TARGET",
            "q-periapt-c-abi2-0.1.2-${{ matrix.target }}.tar.gz",
            "q-periapt-android-0.1.2.aar",
            "q-periapt-android-0.1.2/MANIFEST.json",
        ):
