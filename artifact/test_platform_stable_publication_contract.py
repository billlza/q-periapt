...
def pending_receipt() -> dict[str, object]:
    ...
    return {
        "boundary": contract.PLATFORM_V0_1_1_PUBLICATION_BOUNDARY,
        "identity": {
        ...
        "kind": contract.PLATFORM_V0_1_1_PUBLICATION_KIND,
        "observation": {
        ...
        "schema_version": contract.PLATFORM_V0_1_1_PUBLICATION_SCHEMA_VERSION,
        "status": contract.PLATFORM_V0_1_1_STATUS_PENDING,
    }


def verified_receipt() -> dict[str, object]:
    receipt = pending_receipt()
    receipt["status"] = contract.PLATFORM_V0_1_1_STATUS_VERIFIED
...
class PlatformV011PublicationContractTests(unittest.TestCase):
        ...
        for value in (
            ...
            with self.subTest(value=value):
                with self.assertRaises(
                    contract.PlatformV011PublicationContractError
                ):
    ...
    def test_v0_1_1_identity_and_current_proof_schema_authority_are_explicit(
        self,
    ) -> None:
        self.assertEqual(contract.PRODUCT_VERSION, "0.1.1")
        self.assertEqual(contract.DISTRIBUTION_REVISION, "r1")
        self.assertEqual(
            contract.RELEASE_TAG, "abi2-platforms-v0.1.1"
        )
        self.assertEqual(
            contract.PLATFORM_V0_1_1_PUBLICATION_KEY,
            "platform_v0_1_1",
        )
        self.assertEqual(
        ...
        self.assertEqual(contract.PLATFORM_V0_1_1_PUBLICATION_SCHEMA_VERSION, 3)
        self.assertEqual(
