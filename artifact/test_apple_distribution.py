    ...
    def test_emits_honest_signed_static_sdk_semantics(self) -> None:
        ...
        self.assertEqual(
            evidence["release_identity"],
            {
                ...
                "revision": "r1",
                "tag": "v0.1.1",
                "url": "https://github.com/billlza/q-periapt/releases/tag/v0.1.1",
            },
        )
        self.assertEqual(
...
class ReleaseAssetVerificationTests(ZipFixture):
    ...
    def _publish(self) -> None:
        ...
        stable = pending["release_publications"][
            apple_publication_contract.APPLE_V0_1_1_PUBLICATION_KEY
        ]
...
class ReleaseWorkflowSourceTests(unittest.TestCase):
    ...
    def test_release_revision_and_toolchain_are_exactly_bound(self) -> None:
        self.assertEqual(apple_distribution.PRODUCT_VERSION, "0.1.1")
        self.assertEqual(apple_distribution.RELEASE_REVISION, "r1")
        self.assertEqual(
            apple_distribution.RELEASE_TAG, "v0.1.1"
        )
        self.assertEqual(
            apple_distribution.RELEASE_URL,
            "https://github.com/billlza/q-periapt/releases/tag/v0.1.1",
        )
        self.assertEqual(
            apple_distribution.PUBLISHED_ALPHA2_R1_RELEASE_IDENTITY,
            (
