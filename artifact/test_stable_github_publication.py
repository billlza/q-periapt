...
EXPECTED_ACTION_IDS = (
    ...
    "upload-platform-02-q-periapt-android-0.1.0-16k-runtime-evidence.zip",
    "upload-platform-03-q-periapt-android-0.1.0-MANIFEST.json",
    "upload-platform-04-q-periapt-android-0.1.0.aar",
    "upload-platform-05-q-periapt-c-abi2-0.1.0-aarch64-unknown-linux-gnu.tar.gz",
    "upload-platform-06-q-periapt-c-abi2-0.1.0-x86_64-unknown-linux-gnu.tar.gz",
    "publish-apple",
    "publish-platform",
)
...
def fixture_plan() -> publication.PublicationPlan:
    ...
    plan = publication.PublicationPlan(
        ...
        releases=(
            release(
                "apple",
                apple_contract.APPLE_V0_1_0_IDENTITY["release_tag"],
                _hex40(5),
...
class StableGitHubPublicationTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.root = publication_state / "github-stable-v0.1.0"
    ...
    def test_all_actions_match_an_independent_literal_oracle(self) -> None:
        expected = (
            ...
            (
                8,
                (
                    "upload-platform-02-q-periapt-android-0.1.0-"
            ...
            (
                11,
                (
                    "upload-platform-05-q-periapt-c-abi2-0.1.0-"
            ...
            (
                12,
                (
                    "upload-platform-06-q-periapt-c-abi2-0.1.0-"
    ...
    def test_prepare_state_bootstrap_creates_only_fixed_private_chain(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            expected = base / ".q-periapt" / "publication-state" / "github-stable-v0.1.0"
            with (
                mock.patch.object(
    ...
    def test_created_state_identity_rejects_root_replacement_before_lock(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                ...
                moved = expected.parent / "github-stable-v0.1.0.moved"
