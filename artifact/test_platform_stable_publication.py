...
class PlatformV011PublicationTests(unittest.TestCase):
    TAG_COMMIT = "1" * 40
    ...
    def test_direct_child_sanitizer_uses_scanner_visible_guard(self) -> None:
        ...
        self.assertEqual("PlatformV011PublicationError", raised.exc.func.id)
    ...
    def test_pending_receipt_is_exact_private_and_attempt_two_valid(self) -> None:
        ...
        contract.validate_v0_1_1_publication_receipt(receipt)
        self.assertEqual(contract.PLATFORM_V0_1_1_STATUS_PENDING, receipt["status"])
        self.assertEqual(
            {
    ...
    def test_pending_resamples_assembly_transaction_before_receipt_commit(self) -> None:
        ...
        with (
            ...
            self.assertRaises(publication.PlatformV011PublicationError),
        ):
    ...
    def test_cli_markers_identify_receipt_digest_for_both_states(self) -> None:
        output = self.root / "platform-v0.1.1-publication-receipt.json"
    ...
    def test_fixed_root_bootstrap_accepts_owned_0775_parent_only(self) -> None:
        ...
        with mock.patch.object(
            ...
            with self.assertRaisesRegex(
                publication.PlatformV011PublicationError,
                "non-world-writable",
            ):
                publication._ensure_platform_safe_roots()
        ...
        with mock.patch.object(
            ...
            with self.assertRaises(publication.PlatformV011PublicationError):
                publication._ensure_platform_safe_roots()
    ...
    def test_verified_transaction_uses_exact_bounded_commands_and_private_bytes(self) -> None:
        ...
        contract.validate_v0_1_1_publication_receipt(receipt)
        self.assertEqual(contract.PLATFORM_V0_1_1_STATUS_VERIFIED, receipt["status"])
    ...
    def test_raw_swap_at_commit_window_leaves_receipt_root_unchanged(self) -> None:
        ...
        real_validate = publication.validate_v0_1_1_publication_receipt
        swapped = False
        ...
        def validate_and_swap(value: object) -> None:
            ...
            if (
                ...
                and value.get("status") == contract.PLATFORM_V0_1_1_STATUS_VERIFIED
            ):
                swapped = True
                raw.rename(moved)
                raw.mkdir(mode=0o700)
    ...
    def test_retryable_remote_failure_is_not_retried(self) -> None:
        ...
        verified_before = set(self.receipt_root.glob("transaction.verified.*"))
        with self.assertRaisesRegex(
            publication.PlatformV011PublicationRetryableError,
    ...
    def test_real_source_inspector_requires_clean_annotated_tag_checkout(self) -> None:
        ...
        with self.assertRaisesRegex(
            publication.PlatformV011PublicationError, "dirty"
        ):
