...
% ---- achieved ceiling ----
\node[ceil, text width=72mm] (ceil)
  {\textbf{Achieved ceiling on the standard axes}\\[2pt]
   \mbox{MAL-BIND-K-CT} \;$\wedge$\; \mbox{MAL-BIND-K-PK}\\[1pt]
   {\scriptsize ContextBound separately proves a syntactic K-CTX extension (not a CDM axis)}};
