...
decapsulation key secret produces, on the NEON path, $2848$ reports across $30$ branches comparing
12-bit coefficients to $q$---which look exactly like a KyberSlash-class leak. They are not: the
