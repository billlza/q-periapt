...
\emph{structurally unachievable}, since decapsulation never returns $\bot$; the binding of implicitly-rejecting KEMs is studied in detail in~\cite{schmieg,cdmrej}.
