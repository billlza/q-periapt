...
object PqtHybrid {
    ...
    private val mlkemKeypair = handle("pqt_mlkem768_keypair", keypairDesc)
    private val x25519Keypair = handle("pqt_x25519_keypair", keypairDesc)
    ...
    private val decap = handle("pqt_hybrid_decapsulate", decapDesc)
    ...
    fun mlkem768Keypair(seed: ByteArray): Pair<ByteArray, ByteArray> = Arena.ofConfined().use { a ->
        ...
        require(rc == 0) { "pqt_mlkem768_keypair rc=$rc" }
    ...
    fun x25519Keypair(secret: ByteArray): Pair<ByteArray, ByteArray> = Arena.ofConfined().use { a ->
        ...
        require(rc == 0) { "pqt_x25519_keypair rc=$rc" }
    ...
    fun decapsulate(
        ...
        require(rc == 0) { "pqt_hybrid_decapsulate rc=$rc" }
