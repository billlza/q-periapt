...
├── formal/           # ✅ EasyCrypt binding proof (easycrypt/BindingViaCR.ec) + Tamarin & ProVerif handshake models — CI hard-gates no-admit/lemma-presence; checker execution best-effort
