...
stable binary targets are the Apple `v0.1.4` XCFramework and the
`abi2-platforms-v0.1.4` Android/Linux packages; only their
...
- Android product surface: rebuild the target-selected AAR (native arm64-v8a,
  ...
  `abi2-platforms-v0.1.4` target with an API 35 / 16 KiB-page emulator
