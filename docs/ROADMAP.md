...
5. **Embedding and package distribution.** `artifact/embedding-readiness.sh` now gives
   ...
   Package `0.1.0-alpha.2` is the pre-publication package-ready research-alpha source/crate line and has a
